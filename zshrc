...
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status nvm rvm background_jobs ram) 
...
alias mtoggle='/home/panickk/.config/i3/toggle_mouse_keys.sh'
alias lock="i3lock-fancy -t 'Waiting for PanicKk'"
alias i3lf='i3lock-fancy'
alias clidiscord='cd ./6cord && ./6cord -t "MzQyMDM1MjkzMTE0ODU5NTMw.XZkPcQ.YQyzvZk_Emr1BmK_r7KgvCMYZ5E"'
alias cmatrix='cmatrix -C cyan -B'
alias pipes-sh='./runpipes.sh -c 6'
